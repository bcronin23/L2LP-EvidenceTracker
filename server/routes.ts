...
const PLU_TO_AREA_CODE: Record<string, string> = {
  ...
  "SC_L1LP-Personal Care-SELF-AWARENESS-AND-SELF-CARE": "PERSONAL_CARE",
  "SC_L1LP-Personal Care-CONNECTING-WITH-MYSELF-AND-OTHERS": "PERSONAL_CARE",
  "SC_L1LP-Personal Care-MINDING-MYSELF": "PERSONAL_CARE",
...
function transformOutcomesForNewSchema(jsonOutcomes: any[], programmeMap: Map<string, string>) {
  return jsonOutcomes.map((o: any) => ({
    ...
    moduleTitle: o.module_title || null,
    strandTitle: o.strand_title || null,
    outcomeLabel: o.outcome_label || null,
